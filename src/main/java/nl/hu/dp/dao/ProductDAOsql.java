...
public class ProductDAOsql implements ProductDAO{
    ...
    public OVChipkaartDAOsql getOdoa() {
        return odoa;
    }

    public void setOdoa(OVChipkaartDAOsql odoa) {
        this.odoa = odoa;
    }

    private OVChipkaartDAOsql odoa;
    ...
    public boolean save(Product inProduct) throws SQLException{
        try{
            PreparedStatement preparedStatement =  conn.prepareStatement("INSERT INTO product (product_nummer, naam, beschrijving, prijs) VALUES (?,?,?,?);");
            ...
            if(inProduct.getOvChipkaarten() != null && odoa != null) {
                for (OVChipkaart inOvKaart : inProduct.getOvChipkaarten()) {
                    ...
                    PreparedStatement preparedStatement2 = conn.prepareStatement("INSERT INTO ov_chipkaart_product (product_nummer, kaart_nummer, status, last_update) VALUES (?,?,?,?);");
    ...
    public boolean delete(Product product) throws SQLException{
        try{
            if(findById(product.getProductNummer()).getOvChipkaarten().size() > 0){
                PreparedStatement preparedStatement1 = conn.prepareStatement("DELETE FROM ov_chipkaart_product WHERE product_nummer = ?");
